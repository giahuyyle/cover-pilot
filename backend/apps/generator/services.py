...
def _build_user_message(
    ...
    return (
        ...
        "For bullet shaping, maximize semantic and lexical match to the job description while staying truthful.\n"
        "Identify top JD keywords (tools, frameworks, domain verbs, core responsibilities) and distribute them across Experience, Projects, and Skills bullets.\n"
        "Prioritize JD must-have requirements in the strongest and most relevant bullets, and front-load highest-match bullets for each role/project.\n"
        "Mirror JD terminology with exact or near-exact phrasing when it is truthful to the candidate's background.\n"
        "When direct experience is missing, use transferable-skill phrasing; allow only light inference from adjacent experience.\n"
        "Do not invent concrete achievements, metrics, employers, tools, or responsibilities not supported by the resume context.\n\n"
