...
export default function Tailor() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            setLoading(true);
            const path = `/api/tailor/${encodeURIComponent(provider)}/${encodeURIComponent(model)}/`;
    ...
    return (
        <div className="mx-auto max-w-7xl px-4 pb-24 sm:px-6 lg:px-8">
            <header className="mb-8 grid gap-6 border-b border-[#e3dece] pb-6 lg:grid-cols-[1fr_360px] lg:items-end">
                <div>
                    <h1 className="text-3xl font-semibold tracking-tight text-zinc-950 sm:text-4xl">Tailor uploaded resume</h1>
                    <p className="mt-3 max-w-2xl text-sm leading-6 text-zinc-600">
                        Upload your resume, paste the role, choose a template, and tailor a document for your next application.
                    </p>
                    {isGuest && (
